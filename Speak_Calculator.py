...
if __name__ == '__main__':
    ...
    if z== "yes":
        ...
        y= input()
        if y== "+":
            print(f"Addition be {int(num1)+int(num2)}, have a nice day")
            speak(f"Addition be {int(num1)+int(num2)}, have a nice day")
        elif y== "-":
            print(f"Subtraction be {int(num1)-int(num2)}, have a nice day")
            speak(f"Subtraction be {int(num1)-int(num2)}, have a nice day")
        elif y== "*":
            print(f"Multiplication be {int(num1)*int(num2)}, have a nice day")
            speak(f"Multiplication be {int(num1)*int(num2)}, have a nice day")
        elif y== "/":
            print(f"Division be {float(num1)/float(num2)}, have a nice day")
            speak(f"Division be {float(num1)/float(num2)}, have a nice day")
        elif y== "%":
            print(f"Remainder be {int(num1)%int(num2)}, have a nice day")
            speak(f"Remainder be {int(num1)%int(num2)}, have a nice day")
    elif z== "no":
